...
import ListItemSeparators from './ListItemSeparator'
import Loadings from './Loading'
import MyButtons from './MyButton'
import MyStatusBars from './MyStatusBar'
...
export const ListItemSeparator = ListItemSeparators
export const Loading = Loadings
export const MyButton = MyButtons
export const MyStatusBar = MyStatusBars
